...
const AUTH_ERROR_MAP: Record<string, string> = {
  ...
  'auth/account-exists-with-different-credential': 'An account already exists with this email using a different sign-in method. Please use that method to sign in.',
  'auth/unauthorized-domain': 'This domain is not authorized for OAuth. Contact the administrator.',
